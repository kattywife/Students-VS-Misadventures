...
# НЕЙРОСЕТИ
NEURO_MOWERS_DATA = {
    'chat_gpt': {'cost': 10, 'display_name': 'ChatGPT', 'description': 'Стандартная защита. При контакте уничтожает всех врагов на линии.'},
    'deepseek': {'cost': 25, 'display_name': 'DeepSeek', 'description': 'При контакте находит и уничтожает 3 самых близких к базе врага.'},
