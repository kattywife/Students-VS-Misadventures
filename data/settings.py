...
ENEMIES_DATA = {
    ...
    'professor': {'health': 350, 'speed': 0.5, 'damage': 50, 'cooldown': 1.0, 'radius': 2, 'debuff': 0.5, 'display_name': "Душный препод", 'category': 'enemies', 'description': "Враг поддержки с огромным запасом здоровья. Создает вокруг себя поле, которое ослабляет урон всех снарядов, пролетающих через него. В ближнем бою атакует сам.",
                  'animation_data': {'folder': 'professor', 'speed': 0.3, 'walk': [], 'attack': [], 'hit': []}},
