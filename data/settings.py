...
'professor': {'health': 350, 'speed': 0.5, 'damage': 50, 'cooldown': 1.0, 'display_name': "Душный препод", 'category': 'enemies',
              'description': "Медленный, но очень живучий враг. Просто идет вперед и поглощает много урона, прежде чем атаковать в ближнем бою.",
