...
# =============================================================================
# Этот файл является центральным хранилищем всех "магических чисел",
# связанных с позиционированием, размерами и отступами элементов интерфейса.
# Группировка по экранам помогает поддерживать порядок.

# --- Общие элементы ---
DEFAULT_BORDER_RADIUS = 10  # Скругление углов для большинства элементов
DEFAULT_BORDER_WIDTH = 2
THICK_BORDER_WIDTH = 3

# --- Стартовый экран и Меню ---
MENU_OVERLAY_ALPHA = 150             # Прозрачность затемняющего слоя
TITLE_PLAQUE_SIZE = (900, 180)       # Размер плашки с названием игры
TITLE_PLAQUE_TEXT_V_OFFSET = 5       # Вертикальное смещение текста на плашке
...
# Списки кортежей для создания кнопок в универсальном меню (пауза, победа и т.д.)
PAUSE_MENU_BUTTONS = [
